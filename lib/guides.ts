...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    slug: "questions-to-ask-your-deck-builder",
    href: "/questions-to-ask-your-deck-builder",
    number: "04",
    hubTitle: "Questions to Ask Before You Sign",
    hubBlurb:
      "The 10 questions that expose a weak deck contract — and what a good answer sounds like. Ungated, as always.",
    landingTitle: "Before You Sign a Contract",
    landingBlurb: "The 10 questions that expose a weak deck bid — and what good answers sound like.",
    chip: "GUIDE · PDF",
    pdf: "/guides/questions-to-ask-your-deck-builder.pdf",
    readLabel: "6 min read",
    updated: "July 2026",
  },
  {
    key: "inspection-guide",
    slug: "deck-safety-inspection-guide",
    href: "/deck-safety-inspection-guide",
    number: "05",
    hubTitle: "The 10-Minute Deck Safety Inspection",
    hubBlurb:
      "Check your own deck the way we would — ledger, footings, railings — and know repair vs. replace before anyone quotes you.",
    landingTitle: "The Deck Safety Inspection",
    landingBlurb: "Check your own deck the way we would, in ten minutes flat.",
    chip: "GUIDE · PDF",
    pdf: "/guides/deck-safety-inspection-guide.pdf",
    readLabel: "Printable",
    updated: "July 2026",
  },
  {
