...
export function ReviewsMarquee() {
  ...
  return (
    <Section className="overflow-hidden" innerClassName="!px-0 max-w-none">
      <div className="mx-auto mb-14 max-w-7xl px-5 sm:px-8">
        <div className="flex flex-wrap items-end justify-between gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="border-border/60 bg-background/40 hover:bg-background/80 inline-flex items-center gap-3 rounded-full border px-4 py-2 text-sm backdrop-blur transition-colors"
          >
            ...
            <span className="text-foreground/80">({site.rating.count}) on Google</span>
          </a>
        </div>
      </div>
