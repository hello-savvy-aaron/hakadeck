...
export const metadata: Metadata = {
  ...
  description:
    "Composite and hardwood decks, pergolas and patio covers, outdoor kitchens, railings, and deck repair — built by a specialist deck company, not handymen or general contractors, across the Denver and Colorado Springs areas.",
